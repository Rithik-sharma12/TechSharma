...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    subsection: Schema.Attribute.String;
...
export interface ApiIdeaIdea extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User submitted ideas and suggestions';
    displayName: 'Idea';
    pluralName: 'ideas';
    singularName: 'idea';
  };
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['feature', 'improvement', 'bug', 'content', 'other']
    > &
...
export interface ApiSectionSection extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Blog sections/categories';
    displayName: 'Section';
    pluralName: 'sections';
